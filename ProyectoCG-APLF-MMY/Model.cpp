...
void Model::LoadModel(const std::string & fileName)
{
	...
	const aiScene* scene = importer.ReadFile(fileName, aiProcess_Triangulate); //Cambiando esta linea
	if (!scene)
	{	
...
void Model::LoadMaterials(const aiScene * scene)
{
	...
	for (unsigned int i = 0; i < scene ->mNumMaterials; i++)
	{
		...
		/*Sí no se tiene una textura entonces le pone una blanca :o*/
		if (!TextureList[i])
		{
...
/*Con shift mantienes seleción y con Control removemos selección*/